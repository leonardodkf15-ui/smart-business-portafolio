...
export const metadata: Metadata = { title: "Week 1 — Week 0 Build" };

export default function Week1Page() {
  return <ComingSoon week={1} />;
}

function ComingSoon({ week }: { week: number }) {
  return (
    <div className="mx-auto flex max-w-5xl flex-col items-center justify-center px-4 py-40 text-center sm:px-6">
      ...
      <p className="mb-8 max-w-sm text-zinc-500">
        Week {week} content is in progress. Check back soon.
      </p>
      <Link
        href="/"
